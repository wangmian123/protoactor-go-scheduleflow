...
// source: scheduleflow.io/protoactor-go/scheduleflow/pkg/apis/k8sproxy/kubernetes-api.proto
...
func init() {
	proto.RegisterFile("scheduleflow.io/protoactor-go/scheduleflow/pkg/apis/k8sproxy/kubernetes-api.proto", fileDescriptor_5ce4d5bbf0aa9e50)
}
