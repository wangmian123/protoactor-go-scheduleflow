...
import (
	...
	"github.com/asynkron/protoactor-go/scheduleflow/pkg/foundation/k8sproxy/server/informer-server/subscribe"
...
func (inf *informerServer) Receive(_ actor.Context) {}
